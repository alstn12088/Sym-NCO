...
def get_options(args=None):
    ...
    parser.add_argument('--N_aug', type=int, default=10, help="The size of the problem graph")
    parser.add_argument('--K', type=int, default=1, help="The size of the problem graph")
